...
RESTRICTED_KEYS = {"national_id", "passport_number", "bank_account", "health", "disability", "emergency_contact", "family_information", "reference_contact", "api_key", "password", "verification_code"}

def blank_profile() -> dict[str, Any]:
    return {
        "schema_version": "1.1",
        "personal": {"full_name": "", "preferred_name": "", "gender": "", "birth_date": "", "nationality": "中国", "phone": "", "email": "", "wechat": "", "current_city": "", "district": "", "address": "", "postal_code": "", "hometown": "", "birthplace": "", "hukou_location": "", "political_status": "", "github": "", "linkedin": "", "portfolio": "", "work_authorization": "", "military_status": ""},
        "intent": {"target_roles": [], "preferred_cities": [], "industries": [], "employment_type": "", "availability": "", "days_per_week": "", "internship_months": "", "salary_monthly": "", "relocation": ""},
        ...
        "sensitive": {"national_id": "", "passport_number": "", "bank_account": "", "health": "", "emergency_contact": "", "family_information": "", "reference_contact": ""},
...
def validate(profile: dict[str, Any]) -> list[str]:
    errors = []
    if profile.get("schema_version") not in {"1.0", "1.1"}:
    ...
    for section in ("education", "experience", "projects", "certificates", "campus_experience", "volunteer_experience"):
